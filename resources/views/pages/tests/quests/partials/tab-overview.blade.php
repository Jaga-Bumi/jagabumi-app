<div id="tab-overview" class="tab-content">
  ...
  <div class="mb-8">
    ...
    <div class="bg-gray-100 rounded-lg p-8 text-center mb-4">
      ...
      <p class="font-medium text-gray-900 mb-1">{{ $quest->location_name }}</p>
      <p class="text-sm text-gray-500">Lat: {{ $quest->latitude }}, Long: {{ $quest->longitude }}</p>
      <p class="text-sm text-gray-500">Check-in Radius: {{ $quest->radius_meter }}m</p>
    </div>

    <a href="https://www.google.com/maps?q={{ $quest->latitude }},{{ $quest->longitude }}" target="_blank" rel="noopener noreferrer" 
       class="inline-flex items-center justify-center gap-2 w-full px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 text-gray-700 font-medium">
