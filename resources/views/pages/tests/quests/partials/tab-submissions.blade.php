          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 flex-wrap mb-2">
                <h4 class="font-bold text-gray-900">{{ $submission->user->name }}</h4>
              ...
              <p class="text-sm text-gray-600 mb-2">
                @if(strlen($submission->description) > 150)
              ...
              <p class="text-xs text-gray-500 mb-3">
                Submitted: {{ $submission->submission_date->format('M d, Y H:i') }}
              </p>
...
<div id="submission-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4">
