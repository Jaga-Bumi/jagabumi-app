<div id="tab-managers" class="tab-content hidden">
  ...
  <div class="space-y-4">
    @if($quest->organization->organizationMembers && $quest->organization->organizationMembers->count() > 0)
      @foreach($quest->organization->organizationMembers as $member)
        <div class="flex flex-col sm:flex-row sm:items-center gap-4 p-4 bg-gray-50 rounded-xl">
          <div class="flex items-center gap-4 flex-1">
            ...
            @endif
            <div class="flex-1">
              <h4 class="font-bold text-gray-900">{{ $member->user->name ?? 'Unknown' }}</h4>
