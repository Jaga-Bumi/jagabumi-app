<div id="tab-overview" class="tab-content">
  <!-- Description -->
  <div class="mb-8">
    <h3 class="text-xl font-bold text-gray-900 mb-4">Tentang Quest Ini</h3>
  ...
  @if($quest->liveness_code)
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
      <h3 class="text-lg font-bold text-yellow-900 mb-2 flex items-center gap-2">
        ...
        Liveness Code Kehadiran
      </h3>
      <p class="text-sm text-yellow-800 mb-2">Gunakan kode ini saat melakukan check-in di lokasi quest.</p>
